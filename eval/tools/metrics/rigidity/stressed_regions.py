...
USAGE = "Calculates the Stressed Regions of a protein using FIRST rigity analysis program "
...
if __name__ == "__main__":
	...
	value = float ( runProgram (["rigidity-analysis.py", "--StressedRegions", pdbFilename], outputDir).strip())
	print value
